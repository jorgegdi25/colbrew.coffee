...
export function Footer() {
  return (
    <footer className="bg-[#1a281d] pt-20 pb-10 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 font-inter text-[14px] text-white/70">
              ...
              <li><Link href="#" className="hover:text-[#b4843b] transition-colors">Nuestro Origen</Link></li>
              <li><Link href="#" className="hover:text-[#b4843b] transition-colors">Comunidad</Link></li>
              <li><Link href="#" className="hover:text-[#b4843b] transition-colors">Historias</Link></li>
              <li><Link href="#" className="hover:text-[#b4843b] transition-colors">Contacto</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-9 h-9 rounded-full bg-[#b4843b] flex items-center justify-center text-[#1a281d] hover:bg-white transition-colors">
