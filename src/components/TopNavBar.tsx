        ...
        <div className="hidden lg:flex items-center gap-8 xl:gap-12">
          <div className="flex items-center gap-8">
            {[
              ...
              { label: "Nuestro Origen", href: "/nuestro-origen", active: false },
              { label: "Comunidad", href: "#", active: false },
              { label: "Historias", href: "#", active: false },
              ...
              <Link
                ...
                className={`font-montserrat text-[14px] font-bold ${
                  item.active ? "text-[#1a281d]" : "text-[#1a281d] hover:text-[#b4843b]"
